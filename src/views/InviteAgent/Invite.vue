                ...
                <div class="row col-md-12">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input @change="onChangeLogo" name="logo" type="file" class="form-control" accept="image/*">
                          </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
...
<script setup>
    ...
    const createNewAgent = async()=>{
        ...
        let datap = {
            ...
            agent_bg_color: agent_bg_color.value,
            nationality: nationality.value,
            nid_or_passport: nid_or_passport.value,
            logo: logo.value,
            //company information
            company_name: company_name.value,
            company_registration_number: company_registration_number.value,
            company_trade_license: company_trade_license.value,
            company_trade_license_number: company_trade_license_number,
            company_establish_date: company_establish_date.value,
            company_number_of_employee: company_number_of_employee.value,
            ...
            company_zip_code: company_zip_code.value,
