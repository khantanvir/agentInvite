...
async function fetchPrimary() {
  ...
  try {
    const res = await Request.GET_REQ(`/edit-counselor/${slug}`)
    check_counselor_id.value = res.data.id
  } catch (error) {
  ...
  if (
    ...
    user.value.counselor_id == check_counselor_id.value
  ) {
    try {
    ...
    try {
      ...
      address.value = res.data.address_details
      alternative_contact.value = res.data.alternative_person_contact
      city.value = res.data.city
      counselor_email.value = res.data.counselor_email
      counselor_name.value = res.data.counselor_name
      counselor_phone.value = res.data.counselor_phone
