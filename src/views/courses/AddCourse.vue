        ...
        <div class="statbox widget box box-shadow">
          <div class="widget-content widget-content-area">
            ...
            <div class="row mb-4">
              ...
              <div class="col">
                <div class="form-group mb-4">
                  <label for="general_eligibility">General Eligibility</label>
...
const { requiredText } = useValidator()
...
const rules = computed(() => {
  return {
    ...
    lang_requirements: { required, requiredText },
    course_benifits: { required, requiredText },
    general_eligibility: { required, requiredText },
    key_modules: {
      $each: helpers.forEach({
        module_title: { required },
        module_description: { required, requiredText },
      }),
    },
  }
})
...
const handleSubmit = async () => {
  ...
  try {
    const res = await Request.POST_REQ(data, '/add-course')
    files.value = []
